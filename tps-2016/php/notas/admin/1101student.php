...
<section id="cuerpo">
    <div class="inter">
        <div class="miga">
            <div><a href="inicio">Inicio</a> &nbsp;/&nbsp;  <a href='estudiante'>Estudiantes</a>&nbsp;/&nbsp; Estudiantes 11-01</div>
            <a href="estudiante" class="reg"><span class="im"> </span><span class="tx">Regresar</span></a>

        </div>

				<h1 style="margin:8px 0px 0px 0px;"><img src="interfaz/1101.png" /> Estudiantes 11-01 </h1>
				<div class="buscar">
				<form name='frm_docente' id='frm_docente' action='1101' method='post'>
					<input type='search' placeholder="Buscar Estudiantes 11-01" name='sea_buscar' id='sea_buscar' />
