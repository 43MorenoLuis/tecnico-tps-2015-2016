						...
						<?php
							$numero_registro=1;
							  while($data_persona=pg_fetch_array($query_persona)){
								...
								echo "<td id='updalete'><a href='addrpersona.php?codigo_persona=$per_codigo' title='Modificar'>
										<input type='button'  class='left edit' /></a>
										<a href='procsperson.php?txt_codigo=$per_codigo&proceso=borrar' title='Eliminar'>
