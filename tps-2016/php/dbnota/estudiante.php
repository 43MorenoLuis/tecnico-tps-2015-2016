		...
		<div id='principal'>
			...
			<div class='izquierda'>
					...
					<?php
						include('menu.php');
					?>
					<a id='crear' href='crear_estudiante.php'>Crear Estudiante</a>		
			</div>
			...
			<table>
				...
				<?php
					...
					while($datos_estudiante=pg_fetch_array($query_estudiante)){
							...
							echo "<td id='editar'><a href='crear_estudiante.php?codigo_estudiante=$est_codigo' title='Editar'><img src='img/1.png' class='estiloico' alt='Editar' title='Editar'/></a></td>";
							echo "<td id='eliminar'><a href='proceso_estudiante.php?txt_codigo=$est_codigo&proceso=borrar' title='Eliminar'><img src='img/eliminar.png' class='estiloico' alt='Eliminar' title='Eliminar'/></a></td>";
							echo "</tr>";
